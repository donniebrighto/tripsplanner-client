...
const DEFAULT_PICTURE = "https://www.psy.pl/wp-content/uploads/2018/06/shutterstock_310582886-e1529659041281-864x575.jpg";
   ...
   return (<Card link as={Link} to={`/trips/${props.id}`}>
           <Image src={imageUrl} />
            <Card.Content>
                ...
                <Card.Meta>
                    <Icon name="calendar alternate outline"/><span>{props.startDate} - {props.endDate}</span>
                </Card.Meta>
                <Card.Description>
