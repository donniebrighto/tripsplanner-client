        ...
        return (
            <div>
                ...
                <Switch>
                    ...
                    <PrivateRoute authenticated={isUserAuthenticated} exact path="/trips" component={ExploreTrips}/>
                    <PrivateRoute authenticated={isUserAuthenticated} path="/create" component={NewPlanForm}/>
...
export default connect(null, mapDispatchToProps)(SemanticApp);